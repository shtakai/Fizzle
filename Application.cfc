...
<cfcomponent output="false">
	...
	<!--- ADD THIS FOR Object Relational Mapping (ORM) ---> 
	<cfscript>
		this.ormEnabled		= true;
		this.datasource		= "Fizzle";		// note: cannot use alias defined in ColdBox.cfc here
		this.ormSettings	= {
			cfclocation = ["model"],		// point to your entity location
			dbcreate	= "none",			// we don't want the ORM to build the database for us
			dialect		= "MySQLwithInnoDB",
			logSQL 		= false,
			flushAtRequestEnd = false,		// ColdBox Active Entity will manage this for us
			autoManageSession = false,		// ColdBox will manage this for us
			eventHandling 	  =  false		// disable event handling
		};
	</cfscript>
	...
	<cffunction name="onRequestStart" returnType="boolean" output="true">
		...
		<!--- ADD THIS FOR GENERAL DEBUGGING: use "appreload=1" in the URL to reload the application --->
		...
		<!--- ADD THIS FOR ORM DEBUGGING: use "ormreload=1" in the URL to reload the object relation mappings --->
